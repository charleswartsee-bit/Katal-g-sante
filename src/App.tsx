...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0514] text-white font-sans selection:bg-violet/30">
      {/* Header Section */}
      <header className="pt-16 pb-12 px-4 flex flex-col items-center text-center max-w-5xl mx-auto">
        ...
        <div className="mt-12 w-full max-w-2xl bg-white/5 border border-white/10 rounded-full py-4 px-8 flex items-center justify-between backdrop-blur-md">
          ...
          <div className="text-sm text-text-dim">
            {selectedIds.length < MAX_SELECTION ? `Choose ${MAX_SELECTION - selectedIds.length} more` : 'Selection complete'}
          </div>
        </div>
      </header>
          ...
          >
            <div className="bg-white/5 border border-white/10 rounded-[48px] p-8 md:p-16 backdrop-blur-xl">
              <div className="text-center mb-12">
                ...
                <p className="text-text-dim">Fill in your details and we'll prepare your custom brand package.</p>
              </div>

              {/* Selected Products List */}
              <div className="mb-12">
                <h3 className="text-xs font-bold tracking-widest text-[#B388FF] uppercase mb-6">Selected Products</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-text-dim">Email Address *</label>
                  <input
                    type="email"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-text-dim">Phone Number</label>
                  <input
                    type="tel"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-text-dim">Desired Brand Name</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-text-dim">Additional Notes</label>
                  <textarea
              ...
              <button 
                className={`w-full mt-12 py-6 rounded-3xl font-bold text-lg transition-all duration-300 ${
              ...
              >
                {selectedIds.length === MAX_SELECTION ? 'Soumèt Chwa yo' : `Select ${MAX_SELECTION} products to continue`}
              </button>
            </div>
          </motion.section>
        )}
